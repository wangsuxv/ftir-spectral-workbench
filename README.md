...
当前工作树是本地、尚未发布的 `0.2.0` 候选版本。它以冻结的 v0.1 基线科学路径为基础，只增加 Coarse/Fine Preview、Series Consistency & QC、A↔T 显示与派生导出，以及 Cross 2 / 完整 Self-Cross overview。此工作树尚未同步到 GitHub。
